              ...
              <div className="services-swiper swiper">
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide services-slide">
                    <div className="services-slide-inner">
                      <div className="s-icon">
                        <img src="service-img/" alt="Influencer Marketing" />
                      </div>
                  ...
                  <div className="swiper-slide services-slide">
                    <div className="services-slide-inner">
                      <div className="s-icon">
                        <img src="service-img/" alt="Trending Marketing" />
                      </div>
                  ...
                  <div className="swiper-slide services-slide">
                    <div className="services-slide-inner">
                      <div className="s-icon">
                        <img src="service-img/" alt="Turnkey Solutions" />
                      </div>
                  ...
                  <div className="swiper-slide services-slide">
                    <div className="services-slide-inner">
                      <div className="s-icon">
                        <img src="service-img/" alt="iGaming Software" />
                      </div>
              ...
              <ul className="services-fan">
                ...
                <li>
                  <div className="pos-rel">
                    ...
                    <picture className="cardImg">
                      <img src="service image/j.png" alt="Trending Marketing" />
                    </picture>
                  </div>
                </li>
                ...
                <li>
                  <div className="pos-rel">
                    ...
                    <picture className="cardImg">
                      <img src="service image/q.png" alt="Turnkey Solutions" />
                    </picture>
                  </div>
                </li>
                ...
                <li>
                  <div className="pos-rel">
                    ...
                    <picture className="cardImg">
                      <img src="service image/k.png" alt="iGaming Software" />
                    </picture>
                  </div>
                </li>
              </ul>
