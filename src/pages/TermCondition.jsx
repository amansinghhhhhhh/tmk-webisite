    ...
    <div className="terms-and-conditions container">
      ...
      <ul>
        <li>
          ...
          or is under common control with a party, where &ldquo;control&rdquo;
        ...
        <li>
          <b>Country</b> refers to: United Arab Emirates
        </li>
        <li>
          <b>Company</b> (referred to as either &ldquo;the Company&rdquo;,
          &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this
          Agreement) refers to The Marekting King, Office 607, Makateb
          Building &ndash; Port Saeed &ndash; Al Maktoum Rd &ndash; Deira
          &ndash; Dubai &ndash; United Arab Emirates.
        </li>
        <li>
        ...
        <li>
          <b>Terms and Conditions</b> (also referred as &ldquo;Terms&rdquo;)
        ...
        <li>
          <b>Website</b> refers to The Markting King, accessible from{" "}
          <a href="https://themarketingking.org/">
            https://themarketingking.org/
          </a>
        </li>
        <li>
      ...
      <p>
        ...
        these states, each party&rsquo;s liability will be limited to the
        greatest extent permitted by law.
      </p>

      <h2>
        <b>&ldquo;AS IS&rdquo; and &ldquo;AS AVAILABLE&rdquo; Disclaimer</b>
      </h2>
      <p>
      ...
      <p>
        ...
        company&rsquo;s provider makes any representation or warranty of
      ...
      <p>
        ...
        that is subject to the United States government embargo, or that
      ...
      <p>
        ...
        reasonable efforts to provide at least 30 days&rsquo; notice prior
      ...
      <p>
        ...
        You do not agree to the new terms, in whole or in part, please stop
      ...
      <ul>
        <li>
          By email:{" "}
          <a href="mailto:Info@themarketingking.org" target="_blank" rel="noreferrer">
